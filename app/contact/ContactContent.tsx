              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="text-stone-600 text-base leading-relaxed mb-8 max-w-md mx-auto">
                    Thank you, <strong>{formData.name}</strong>. Jay Maheshwari
                    or Alpesh Maheshwari from our desk will review your
                ...
                >
                  <div>
                    <h2 className="font-serif text-2xl sm:text-3xl font-bold text-[#0B251B] mb-2">
